...
const allGlass = [
  { glass: "glasses/black.png", price: 5000 },
  { glass: "glasses/blue.png", price: 135 },
  { glass: "glasses/reading1.png", price: 6700 },
  { glass: "glasses/reading2.png", price: 13500 },
  { glass: "glasses/red.png", price: 11500 },
  { glass: "glasses/reading3.png", price: 12500 },
];
  ...
  const showAllGlass = allGlass.map((P) => {
   ...
   <div class="flex justify-between w-[100%] items-center p-3">
     <div class="flex items-center justify-center">
       <span class="font-bold text-xl">${P.price}00</span>
